...
var file_greet_greetpb_greet_proto_rawDesc = []byte{
	...
	0x72, 0x65, 0x73, 0x75, 0x6c, 0x74, 0x22, 0x43, 0x0a, 0x14, 0x4c, 0x6f, 0x6e, 0x67, 0x47, 0x72,
	...
	0x67, 0x52, 0x08, 0x67, 0x72, 0x65, 0x65, 0x74, 0x69, 0x6e, 0x67, 0x22, 0x2f, 0x0a, 0x15, 0x4c,
	0x6f, 0x6e, 0x67, 0x47, 0x72, 0x65, 0x65, 0x74, 0x4d, 0x61, 0x6e, 0x79, 0x52, 0x65, 0x73, 0x70,
	...
	0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22, 0x00, 0x28, 0x01, 0x12, 0x50, 0x0a, 0x0d, 0x4c, 0x6f,
	0x6e, 0x67, 0x47, 0x72, 0x65, 0x65, 0x74, 0x4d, 0x61, 0x6e, 0x79, 0x12, 0x1b, 0x2e, 0x67, 0x72,
	0x65, 0x65, 0x74, 0x2e, 0x4c, 0x6f, 0x6e, 0x67, 0x47, 0x72, 0x65, 0x65, 0x74, 0x4d, 0x61, 0x6e,
	0x79, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x1a, 0x1c, 0x2e, 0x67, 0x72, 0x65, 0x65, 0x74,
	0x2e, 0x4c, 0x6f, 0x6e, 0x67, 0x47, 0x72, 0x65, 0x65, 0x74, 0x4d, 0x61, 0x6e, 0x79, 0x52, 0x65,
	0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22, 0x00, 0x28, 0x01, 0x30, 0x01, 0x42, 0x0b, 0x5a, 0x09,
	0x2e, 0x3b, 0x67, 0x72, 0x65, 0x65, 0x74, 0x70, 0x62, 0x62, 0x06, 0x70, 0x72, 0x6f, 0x74, 0x6f,
	0x33,
}
...
var file_greet_greetpb_greet_proto_goTypes = []interface{}{
	...
	(*LongGreetManyRequest)(nil),   // 7: greet.LongGreetManyRequest
	(*LongGreetManyResponse)(nil),  // 8: greet.LongGreetManyResponse
}
var file_greet_greetpb_greet_proto_depIdxs = []int32{
	...
	0, // 3: greet.LongGreetManyRequest.greeting:type_name -> greet.Greeting
	...
	7, // 7: greet.GreetService.LongGreetMany:input_type -> greet.LongGreetManyRequest
	...
	8, // 11: greet.GreetService.LongGreetMany:output_type -> greet.LongGreetManyResponse
...
type GreetServiceClient interface {
	...
	//BiDi streaming
	LongGreetMany(ctx context.Context, opts ...grpc.CallOption) (GreetService_LongGreetManyClient, error)
}
...
func (c *greetServiceClient) LongGreetMany(ctx context.Context, opts ...grpc.CallOption) (GreetService_LongGreetManyClient, error) {
	stream, err := c.cc.NewStream(ctx, &_GreetService_serviceDesc.Streams[2], "/greet.GreetService/LongGreetMany", opts...)
	if err != nil {
		return nil, err
	}
	x := &greetServiceLongGreetManyClient{stream}
	return x, nil
}

type GreetService_LongGreetManyClient interface {
	Send(*LongGreetManyRequest) error
	Recv() (*LongGreetManyResponse, error)
	grpc.ClientStream
}

type greetServiceLongGreetManyClient struct {
	grpc.ClientStream
}

func (x *greetServiceLongGreetManyClient) Send(m *LongGreetManyRequest) error {
	return x.ClientStream.SendMsg(m)
}

func (x *greetServiceLongGreetManyClient) Recv() (*LongGreetManyResponse, error) {
...
type GreetServiceServer interface {
	...
	//BiDi streaming
	LongGreetMany(GreetService_LongGreetManyServer) error
}
...
func (*UnimplementedGreetServiceServer) LongGreetMany(GreetService_LongGreetManyServer) error {
	return status.Errorf(codes.Unimplemented, "method LongGreetMany not implemented")
}
...
func _GreetService_LongGreetMany_Handler(srv interface{}, stream grpc.ServerStream) error {
	return srv.(GreetServiceServer).LongGreetMany(&greetServiceLongGreetManyServer{stream})
}

type GreetService_LongGreetManyServer interface {
	Send(*LongGreetManyResponse) error
	Recv() (*LongGreetManyRequest, error)
	grpc.ServerStream
}

type greetServiceLongGreetManyServer struct {
	grpc.ServerStream
}

func (x *greetServiceLongGreetManyServer) Send(m *LongGreetManyResponse) error {
	return x.ServerStream.SendMsg(m)
}

func (x *greetServiceLongGreetManyServer) Recv() (*LongGreetManyRequest, error) {
...
var _GreetService_serviceDesc = grpc.ServiceDesc{
	...
	Streams: []grpc.StreamDesc{
		...
		{
			StreamName:    "LongGreetMany",
			Handler:       _GreetService_LongGreetMany_Handler,
			ServerStreams: true,
			ClientStreams: true,
		},
	},
